...
return [
    ...
    'Price Fourth Value' => '第四阶梯量',
    'Price Fifth Price' => '第五阶梯价格',
    'Price Fifth Value' => '第五阶梯量',
    'Price Sixth Price' => '第六阶梯价格',
    'Price Sixth Value' => '第六阶梯量',
//    'End Time'     => '结束时间',
    'Save Price'   => '添加/修改价格',
    'Delete Price' => '删除价格',
    'Please Search'=> '请选择',
    ...
    'Operation fail Incomplete Information'         => '操作失败，信息不完整',
    'Please Create Meterdata First'                => '请先创建运行参数！',
    'Please enter M_Code First'     => '请先输入表号',
    'These M_Code are incorrect! Please enter again'     => '以下表号不符合要求！请重新输入',
    'Please choose Area First'      => '请先选择区域',
    'You have no right to the area for this operation'   => '您无权对该区域进行此操作',
    'There are no downloadable M_Code'             => '没有可以下载的表具',
    'The following M_Code number is not downloaded successfully, and the rest has been downloaded' =>     '以下表号未下载成功,其余已下载完成！',
    'Unlawful choice'    => '方式选择不合法',
    'Spicial User Download'  => '指定用户下载',
    'Area User Download'     => '区域用户下载',
    'All User Download'      => '所有用户下载',
    'Sure Controll'          => '确认控制',
    //报表
    'Search Year' => '选择年份',
    'months'      => '月份',
    ...
    'Alarm M_Code'                     =>   '表号',
    'Alarm Level'                      =>   '报警级别',
    'Alarm Start Time'                 =>   '发生起时间',
    'Alarm End Time'                   =>   '发生止时间',
    'Alarm Reason'                     =>   '发生原因',
    'Alarm Time'                       =>   '报警时间',
    'Deal Alarm'                       =>   '处理报警',
    'Alarm Desc'                       =>   '处理结果',
    ...
    'Charge Limit Require'                     => '充值金额必须',
    'Charge Limit Illegal'                     => '充值金额必须大于0',
    ...
    'Chat Status'                       => '消息类别',
    'All Chats'                         => '所有消息',
    'Unchecked Chats'                   => '未读消息',
    'Chat User Last Updatetime'         => '最后留言时间',
    'Chat Detail'                       => '查看详情',
    'Chat Number'                       => '消息数',
    'Shop Self'                         => '店铺',
    'Bad Network,Please Refresh the Page' => '网络状况不佳,请刷新重试',
    'Uid Illegal'                       => '消息id不合法',
    'Chat View'                         => '消息内容',
    'Reply'                             => '回复',
